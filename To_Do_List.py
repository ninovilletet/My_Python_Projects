...
def add_task():
    clear()
    sleep(0.5)
    task_name = input(Fore.GREEN + "Enter the name of the task : " + Fore.RESET)
...
def edit_task():
    ...
    clear()
    sleep(0.5)
    list_tasks[index_task - 1] = input(Fore.GREEN + "Enter the new name of the task : " + Fore.RESET)
    clear()
    sleep(0.5)
    check_list()
    choice_option()
...
def check_list():
    ...
    if not list_tasks:
        ...
        write_green("You have {} tasks to do:".format(len(list_tasks)))
